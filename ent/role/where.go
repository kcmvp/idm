...
func CreateBy(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateBy(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByEQ(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreateBy), v))
	})
}
...
func CreateByNEQ(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByIn(vs ...string) predicate.Role {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateByNotIn(vs ...string) predicate.Role {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateByGT(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByGTE(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByLT(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByLTE(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByContains(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByHasPrefix(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByHasSuffix(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByEqualFold(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func CreateByContainsFold(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByEQ(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdateBy), v))
	})
}
...
func UpdateByNEQ(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByIn(vs ...string) predicate.Role {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateByNotIn(vs ...string) predicate.Role {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateByGT(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByGTE(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByLT(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByLTE(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByContains(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByHasPrefix(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByHasSuffix(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByEqualFold(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func UpdateByContainsFold(v string) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
// HasFuncs applies the HasEdge predicate on the "funcs" edge.
func HasFuncs() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FuncsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, FuncsTable, FuncsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasFuncsWith(preds ...predicate.Fun) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FuncsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, FuncsTable, FuncsPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
